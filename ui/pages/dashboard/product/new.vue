        ...
        btnSave: function() {
            ...
            this.postData("/api/product",{
                ...
                if(this.images !== ""){
                    ...
                    this.postData("/api/product/upload/" + resp.data.id, FD, {"Content-Type": "multipart/form-data", headers:{"Authorization": "key=" + this.$store.state.user.currentUser}}, (resp) => { 
                ...
                alert(err.error != undefined ? err.error : "Error while saving");
            });
        }
    },
    created(){
